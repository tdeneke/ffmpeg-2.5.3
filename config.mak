...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-liborcc264 --enable-liborcc265 --enable-libx264 --enable-libx265
prefix=/usr/local
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -I/usr/local/include -I/usr/local/include -I/usr/local/include -I/usr/local/include -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/local/include/SDL  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat
...
CFLAGS-ffplay=-D_GNU_SOURCE=1 -D_REENTRANT -I/usr/local/include/SDL
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lva -lxcb -lxcb-shm -lxcb -lX11 -ljack -lasound -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lSDL -lpthread -L/usr/local/lib -lx265 -L/usr/local/lib -lx264 -Wl,-rpath,/usr/local/lib -pthread -L/usr/local/lib -lorcc265 -lva -lxcb-shm -lxcb -lX11 -lSDL -lpthread -lm -lbz2 -lz -lrt -Wl,-rpath,/usr/local/lib -pthread -L/usr/local/lib -lorcc264 -lva -lxcb-shm -lxcb -lX11 -lSDL -lpthread -lm -lbz2 -lz -lrt -lm -lbz2 -lz -pthread -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
LIBS-ffplay=-Wl,-rpath,/usr/local/lib -L/usr/local/lib -lSDL -lpthread
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=-lvdpau
!ARCH_AARCH64=yes
...
!CONFIG_LIBOPUS=yes
CONFIG_LIBORCC264=yes
CONFIG_LIBORCC265=yes
!CONFIG_LIBPULSE=yes
!CONFIG_LIBQUVI=yes
!CONFIG_LIBRTMP=yes
...
CONFIG_LIBORCC264_DECODER=yes
CONFIG_LIBORCC265_DECODER=yes
